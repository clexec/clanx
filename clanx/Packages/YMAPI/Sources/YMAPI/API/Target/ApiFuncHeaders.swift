...
extension ApiFunction {
    ...
    var headers: [String: String] {
        ...
        case .track_download_info_web(_, let secret): return ["Authorization": "OAuth " + secret]
        case .track_download_info_v2(_, _, _, _, let secret): return ["Authorization": "OAuth " + secret]
        case .track_download_info_v2_web(_, _, _, _, let secret): return ["Authorization": "OAuth " + secret]
