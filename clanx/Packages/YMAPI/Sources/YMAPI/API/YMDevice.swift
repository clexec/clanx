...
public class YMDevice {
    ...
    public static func generateWebMimicDevice(uuid: String, os: String = "Android", osVer: String = "15", model: String = "Pixel 9") -> YMDevice {
        return YMDevice(os: os, osVer: osVer, manufacturer: "Google", name: "Google", platform: os.lowercased(), model: model, clid: "2346618", deviceId: uuid, uuid: uuid)
    }
}
