...
func buildWebRequest(basePath: String, payloadPath: String, authHeaderValue: String?, headers: [String: String], method: String, bodyData: Data?) -> URLRequest? {
    ...
    urlReq.allHTTPHeaderFields?["User-Agent"] = YMConstants.UserAgentWeb
    urlReq.allHTTPHeaderFields?["X-Yandex-Music-Client"] = YMConstants.YmClientWeb
    urlReq.allHTTPHeaderFields?["Origin"] = "https://music.yandex.ru"
    urlReq.allHTTPHeaderFields?["Referer"] = "https://music.yandex.ru/"
    urlReq.allHTTPHeaderFields?["X-Yandex-Log-OTID"] = UUID().uuidString.lowercased()
    urlReq.allHTTPHeaderFields?["X-Yandex-Music-Client-ID"] = UUID().uuidString.lowercased()
    if let g_authHeaderValue = authHeaderValue, !g_authHeaderValue.isEmpty {
...
///Initializes request with raw parameters
func buildWebRequest(for method: ApiFunction) -> URLRequest? {
