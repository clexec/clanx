...
enum ApiFunction {
    ...
    case track_download_info_web(trackId: String, secret: String)
    case track_download_info_v2(trackId: String, canUseStreaming: Bool, timestamp: String, sign: String, secret: String)
    case track_download_info_v2_web(trackId: String, canUseStreaming: Bool, timestamp: String, sign: String, secret: String)
